                ...
                "properties": {
                    ...
                    "flight_legs": {
                        ...
                        'items':
                            {
                                "type": "object",
                                'required': ['origin', 'destination', 'earliest_departure_time', 'latest_arrival_time'],
                                "properties": {
                                    "origin": {
                                        "type": "string",
            ...
            "parameters": {
                ...
                "properties": {
                    ...
                    "contiguous_sequence_constraints": {
                        "type": "array",
                        'required': ['city', 'hard_min', 'soft_min', 'soft_max', 'hard_max', 'max_visits'],
                        "items": {
                                "type": "object",
                                "properties": {
                                    "city": {
                    ...
                    "date_range_constraints": {
                        ...
                        "items":
                            {
                                "type": "object",
                                'required': ['city', 'min_start_day', 'max_start_day', 'min_end_day', 'max_end_day', 'visit'],
                                "properties": {
                                    "city": {
                                        "type": "string",
                                        "description": "Airport iata code, e.g. 'LAX'",
